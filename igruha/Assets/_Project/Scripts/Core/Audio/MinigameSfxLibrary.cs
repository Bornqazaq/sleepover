...
namespace Igruha.Core.Audio
{
    ...
    ///
    /// <b>Слот может быть не одним клипом, а пачкой вариаций</b> — шесть шагов по
    /// дереву, четыре падения тела. Это не удобство, а требование поставки: пять
    /// файлов, играемых подряд по кругу, слышны как пулемёт, а случайный выбор из
    /// тех же пяти со сдвигом высоты — как живой шаг. Выбирает вариант
    /// <see cref="MinigameAudioPlayer"/>, библиотека только хранит.
    /// </summary>
    ...
    public sealed class MinigameSfxLibrary : ScriptableObject
    {
        ...
        public struct Entry
        {
            ...
            [Tooltip("Вариации слота: шесть шагов по дереву, четыре падения тела. Пусто — слот звучит одним клипом")]
