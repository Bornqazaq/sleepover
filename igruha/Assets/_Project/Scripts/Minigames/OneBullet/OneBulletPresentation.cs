...
namespace Igruha.Minigames.OneBullet
{
    public sealed class OneBulletPresentation : MonoBehaviour
    {
        ...
        private const float HeldScale = 1.1f, PickupScale = 1.6f, PalmDrop = .06f;
        ...
        private void LateUpdate()
        {
            ...
            if (pickup >= 0)
            {
                ...
                gun.position = game.PickupPosition + Vector3.up * (.22f + Mathf.Sin(Time.time * BobSpeed) * BobAmplitude);
