...
namespace Igruha.Minigames.BelieveOrNot
{
    ...
    public sealed class BelieveDebugBot : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            // клиент. Без этой проверки погонщик играл за живых людей: слал
            // за них реплики и, что хуже, РЕШАЛ ЗА НИХ кон — на пятой-тридцатой
            // секунде уговоров, случайной монеткой, вместо человека, который
            // ещё думает. Ровно тот же класс, что чинили в «Экзамене» 25.08.
